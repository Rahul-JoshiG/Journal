...
class AddJournalActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var mCollectionReference = mFireStore.collection("Journals")
    ...
    private fun saveJournal() {
        ...
        if (title.isNotEmpty() && desc.isNotEmpty() && mImageUri != null) {
            val filePath = mStorageReference.child("Journals_images/${mUser.uid}_image_${Timestamp.now().seconds}")
