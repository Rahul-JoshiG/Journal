...
dependencies {
    ...
    implementation ("com.google.android.gms:play-services-auth:20.5.0") // For Google authentication
    implementation ("com.google.android.gms:play-services-base:17.6.0")  // Core functionality
